...
class CLI:
    ...
    def run(self):
        ...
        print("\\n" + "="*60)
        print("🏷️  GMAIL SUBJECT TAGGER")
        print("="*60)
        print("\\n⚠️  Note: Gmail API doesn't allow direct subject modification.")
            ...
            if cmd == 'quit':
                ...
                try:
                    ...
                    if 0 <= conf <= 1:
                        ...
                        print("  ⚠️  Must be between 0.0 and 1.0")
                except ValueError:
                ...
                confirm = input("  ⚠️  Remove all category labels? (yes/no): ")
